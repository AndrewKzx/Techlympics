...
export default function Component() {
  ...
  {state.show_loans.map((rkpvuyok, i) => (
  <ListItem key={i}>
  <HStack>
  <Text sx={{"fontSize": "1.25em"}}>
  {rkpvuyok}
</Text>
  <Button onClick={(_e) => addEvents([Event("state.finish_item", {item:rkpvuyok})], (_e))} sx={{"height": "1.5em", "backgroundColor": "white", "textColor": "white", "fontSize": "1em"}}>
  {`❌`}
</Button>
</HStack>
</ListItem>
