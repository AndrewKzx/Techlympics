...
export default function Component() {
  ...
  <OrderedList>
  {state.items.map((jqavaznz, szygvogi) => (
  <ListItem key={szygvogi}>
  <HStack>
  <Text sx={{"fontSize": "1.25em"}}>
  {jqavaznz}
</Text>
  <Button onClick={(_e) => addEvents([Event("state.finish_item", {item:jqavaznz})], (_e), {})} sx={{"height": "1.5em", "backgroundColor": "white", "textColor": "white", "fontSize": "1em"}}>
  {`❌`}
</Button>
</HStack>
</ListItem>
  ...
  <Container>
  <Plot data={[{"fill": "tozeroy", "mode": "lines", "name": "Line 1", "x": [1, 2, 3, 4, 5], "y": [2, 4, 1, 7, 4], "type": "scatter"}, {"fill": "tozeroy", "mode": "lines", "name": "Line 2", "x": [1, 2, 3, 4, 5], "y": [1, 3, 2, 5, 6], "type": "scatter"}]} height={`400px`}/>
</Container>
</Box>
</Box>
  <Spacer/>
