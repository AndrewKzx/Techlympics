...
<<<<<<< Updated upstream
  {state.show_loans.map((svzhbefu, i) => (
  <ListItem key={i}>
  <HStack>
  <Box dangerouslySetInnerHTML={{"__html": svzhbefu}}/>
  <Button onClick={(_e) => addEvents([Event("state.finish_item", {item:svzhbefu})], (_e))} sx={{"height": "1.5em", "backgroundColor": "white", "textColor": "white", "fontSize": "1em"}}>
=======
  {state.show_loans.map((qrnxchfz, scyapkkg) => (
  <ListItem key={scyapkkg}>
  <HStack>
  <Box dangerouslySetInnerHTML={{"__html": qrnxchfz}}/>
  <Button onClick={(_e) => addEvents([Event("state.finish_item", {item:qrnxchfz})], (_e), {})} sx={{"height": "1.5em", "backgroundColor": "white", "textColor": "white", "fontSize": "1em"}}>
>>>>>>> Stashed changes
  {`❌`}
</Button>
</HStack>
