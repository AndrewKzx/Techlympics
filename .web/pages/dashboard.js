...
export default function Component() {
  ...
  <OrderedList>
  {state.items.map((wykxmjdj, fkpibkkg) => (
  <ListItem key={fkpibkkg}>
  <HStack>
  <Text sx={{"fontSize": "1.25em"}}>
  {wykxmjdj}
</Text>
  <Button onClick={(_e) => addEvents([Event("state.finish_item", {item:wykxmjdj})], (_e), {})} sx={{"height": "1.5em", "backgroundColor": "white", "textColor": "white", "fontSize": "1em"}}>
  {`❌`}
</Button>
</HStack>
</ListItem>
