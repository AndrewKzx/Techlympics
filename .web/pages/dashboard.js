...
export default function Component() {
  ...
  <OrderedList>
  {state.show_loans.map((xjsxjkfu, i) => (
  <ListItem key={i}>
  <HStack>
  <Text sx={{"fontSize": "1.25em"}}>
  {xjsxjkfu}
</Text>
  <Button onClick={(_e) => addEvents([Event("state.finish_item", {item:xjsxjkfu})], (_e))} sx={{"height": "1.5em", "backgroundColor": "white", "textColor": "white", "fontSize": "1em"}}>
  {`❌`}
</Button>
</HStack>
</ListItem>
