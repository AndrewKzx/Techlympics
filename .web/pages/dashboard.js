...
export default function Component() {
  ...
  <OrderedList>
  {state.show_loans.map((ougiulyl, gmkdhiqm) => (
  <ListItem key={gmkdhiqm}>
  <HStack>
  <Text sx={{"fontSize": "1.25em"}}>
  {ougiulyl}
</Text>
  <Button onClick={(_e) => addEvents([Event("state.finish_item", {item:ougiulyl})], (_e), {})} sx={{"height": "1.5em", "backgroundColor": "white", "textColor": "white", "fontSize": "1em"}}>
  {`❌`}
</Button>
</HStack>
</ListItem>
