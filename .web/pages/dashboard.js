...
export default function Component() {
  ...
  {state.show_loans.map((sursatly, i) => (
  <ListItem key={i}>
  <HStack>
  <Text sx={{"fontSize": "1.25em"}}>
  {sursatly}
</Text>
  <Button onClick={(_e) => addEvents([Event("state.finish_item", {item:sursatly})], (_e))} sx={{"height": "1.5em", "backgroundColor": "white", "textColor": "white", "fontSize": "1em"}}>
  {`❌`}
</Button>
</HStack>
</ListItem>
