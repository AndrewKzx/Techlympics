...
export default function Component() {
  ...
  {state.show_loans.map((pufnnioz, qsnrmavw) => (
  <ListItem key={qsnrmavw}>
  <HStack>
  <Box dangerouslySetInnerHTML={{"__html": pufnnioz}}/>
  <Button onClick={(_e) => addEvents([Event("state.finish_item", {item:pufnnioz})], (_e), {})} sx={{"height": "1.5em", "backgroundColor": "white", "textColor": "white", "fontSize": "1em"}}>
  {`❌`}
</Button>
</HStack>
</ListItem>
