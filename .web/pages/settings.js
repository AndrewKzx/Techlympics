...
export default function Component() {
  ...
  <OrderedList>
  {state.items.map((gozhejcl, fgivpgdr) => (
  <ListItem key={fgivpgdr}>
  <HStack>
  <Text sx={{"fontSize": "1.25em"}}>
  {gozhejcl}
</Text>
  <Button onClick={(_e) => addEvents([Event("state.finish_item", {item:gozhejcl})], (_e), {})} sx={{"height": "1.5em", "backgroundColor": "white", "textColor": "white", "fontSize": "1em"}}>
  {`❌`}
</Button>
</HStack>
</ListItem>
