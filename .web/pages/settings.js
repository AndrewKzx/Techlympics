...
export default function Component() {
  ...
  <OrderedList>
  {state.items.map((megsziiq, pijvlivz) => (
  <ListItem key={pijvlivz}>
  <HStack>
  <Text sx={{"fontSize": "1.25em"}}>
  {megsziiq}
</Text>
  <Button onClick={(_e) => addEvents([Event("state.finish_item", {item:megsziiq})], (_e), {})} sx={{"height": "1.5em", "backgroundColor": "white", "textColor": "white", "fontSize": "1em"}}>
  {`❌`}
</Button>
</HStack>
</ListItem>
