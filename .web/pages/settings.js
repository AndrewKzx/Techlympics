...
export default function Component() {
  ...
  {state.show_loans.map((tqawnzda, i) => (
  <ListItem key={i}>
  <HStack>
  <Box dangerouslySetInnerHTML={{"__html": tqawnzda}}/>
  <Button onClick={(_e) => addEvents([Event("state.finish_item", {item:tqawnzda})], (_e))} sx={{"height": "1.5em", "backgroundColor": "white", "textColor": "white", "fontSize": "1em"}}>
  {`❌`}
</Button>
</HStack>
</ListItem>
