...
=======
  {state.show_loans.map((pafslvla, idvwwcrs) => (
  <ListItem key={idvwwcrs}>
  <HStack>
  <Box dangerouslySetInnerHTML={{"__html": pafslvla}}/>
  <Button onClick={(_e) => addEvents([Event("state.finish_item", {item:pafslvla})], (_e), {})} sx={{"height": "1.5em", "backgroundColor": "white", "textColor": "white", "fontSize": "1em"}}>
>>>>>>> Stashed changes
  {`❌`}
</Button>
</HStack>
