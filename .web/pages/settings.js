...
export default function Component() {
  ...
  {state.show_loans.map((olyacawx, i) => (
  <ListItem key={i}>
  <HStack>
  <Box dangerouslySetInnerHTML={{"__html": olyacawx}}/>
  <Button onClick={(_e) => addEvents([Event("state.finish_item", {item:olyacawx})], (_e))} sx={{"height": "1.5em", "backgroundColor": "white", "textColor": "white", "fontSize": "1em"}}>
  {`❌`}
</Button>
</HStack>
</ListItem>
