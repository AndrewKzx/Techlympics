...
export default function Component() {
  ...
  <OrderedList>
  {state.show_loans.map((dborxaxm, moesxkwp) => (
  <ListItem key={moesxkwp}>
  <HStack>
  <Text sx={{"fontSize": "1.25em"}}>
  {dborxaxm}
</Text>
  <Button onClick={(_e) => addEvents([Event("state.finish_item", {item:dborxaxm})], (_e), {})} sx={{"height": "1.5em", "backgroundColor": "white", "textColor": "white", "fontSize": "1em"}}>
  {`❌`}
</Button>
</HStack>
</ListItem>
