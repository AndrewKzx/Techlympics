...
export default function Component() {
  ...
  <OrderedList>
  {state.show_loans.map((cblgnywz, bzoffepm) => (
  <ListItem key={bzoffepm}>
  <HStack>
  <Text sx={{"fontSize": "1.25em"}}>
  {cblgnywz}
</Text>
  <Button onClick={(_e) => addEvents([Event("state.finish_item", {item:cblgnywz})], (_e), {})} sx={{"height": "1.5em", "backgroundColor": "white", "textColor": "white", "fontSize": "1em"}}>
  {`❌`}
</Button>
</HStack>
</ListItem>
